...
+(instancetype)randomItem
{
    ...
    MNItem *newItem = [[self alloc] initWithItemName:randomName
...
-(void)encodeWithCoder:(NSCoder *)aCoder //KeyedArchiver represents this object
{
...
-(instancetype)initWithCoder:(NSCoder *)aDecoder //KeyedUnarchiver represents this object
{
    self = [super init];
    if (self)
    {
